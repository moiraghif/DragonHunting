...
for ep in range(0, EPISODES):
    ...
    if ep%10 == 0:
        world1.save_qtable()
    print("Episode:{0:5}, game ended:{1:4} Training Status: [{2:10}]{3:3}%, time: {4}s".format(ep+1,game_ended,'#'*(round(ep*10/EPISODES)+1),round((ep+1)*100/EPISODES),round(time_used)),end='\r')
