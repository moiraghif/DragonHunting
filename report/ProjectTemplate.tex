...
%Risultati
The training required $\sim$3 hours (6-7 times faster than Deep Q-Learning) and the average score of the trained model, over 1000 episodes, was 384, slightly higher that the Deep Q-Learning Method.
\newpage
\begin{figure}[!h]
	\vspace{-1cm}
...
\end{figure}
\begin{figure}[!h]
	\includegraphics[width=\linewidth]{./figs/q_epoch_15.png}
	\caption{Epoch required in Q-Learning Training Phase}
\end{figure}
\begin{figure}[!h]
	\includegraphics[width=\linewidth]{./figs/q_reward_15.png}
	\caption{Rewards in Q-Learning Training Phase}
\end{figure}
\begin{figure}[!h]
	\includegraphics[width=\linewidth]{./figs/deep_train.png}
	\caption{Training phase of Deep Q-Learning}
\end{figure}
\begin{figure}[!h]
	\includegraphics[width=\linewidth]{./figs/deep_ga_train.png}
