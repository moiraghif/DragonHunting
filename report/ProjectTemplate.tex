...
\end{itemize}
%The creation of these components is carried out at locations where there are no obstacles or other characters, so that the grid remains consistent, while checking whether a cell at a given coordinate is borderline.\\* %non credo serva dirlo
